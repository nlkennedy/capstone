                        ...
                        <table className="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th className="w-50 matchup-header" scope="col">Game</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        { match.games.length < 5 && 
                                                            [...Array(match_length - match.games.length)].map((e, i) => <td className="text-light" key={"game-filler-home-" + match.pk + "-" + i} width="20%">0</td>)
                                                        }
                                                    </tr>
                                                    <tr>
                                                        { match.games.map(game => 
                                                        ...
                                                        { match.games.length < 5 && 
                                                            [...Array(match_length - match.games.length)].map((e, i) => <td className="text-light" key={"game-filler-away-" + match.pk + "-" + i} width="20%">0</td>) 
                                                        }
                                                    </tr>
                                                </tbody>
                                            </table>
